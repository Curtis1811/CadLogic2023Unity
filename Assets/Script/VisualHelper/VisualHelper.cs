...
namespace VisualRerendering
{
    ...
    {
        public static void DrawPointsToScreen(Vector3 Position, Color color = default)
        {
        ...
        public static void DrawLineToScreen(Vector3 start, Vector3 end, Color color = default)
        {
